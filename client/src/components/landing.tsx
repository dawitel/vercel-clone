  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900 p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-xl">Deploy your App on <span className="text-2xl text-red-600 font-bold">WALMART-VERCEL</span></CardTitle>
      ...
      {deployed && <Card className="w-full max-w-md mt-8">
        <CardHeader>
          ...
          <CardDescription>Your App is successfully deployed!</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
          ...
          <Button className="w-full" variant="outline">
            <a href={`http://${uploadId}.walmart_vercel.com/index.html`} target="_blank">
              Visit Your App
            </a>
          </Button>
        </CardContent>
